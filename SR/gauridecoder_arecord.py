...
class HotwordDetector(object):
    ...
    def record_proc(self):
        ...
        print('Recording command is ', cmd)
    ...
    def callBackRecord(self, detected_callback=play_audio_file,
                       interrupt_check=lambda: False,
                       audio_recorder_callback=None,
                       sleep_time=0.03,
                       silent_count_threshold=60,recording_timeout=60):
        recordingCount = 0
        silentCount = 0       
        hasSpoken = False
        self.recordedData = []        
        ...
        while True:
            ...
            if status == 0:
                hasSpoken = True
            if status == -2 and len(data) == 4096 and hasSpoken: #silence found            
                stopRecording = True
            else:
    ...
    def saveMessage(self):
        ...
        wf.setnchannels(1)
        audio = pyaudio.PyAudio()
        wf.setsampwidth(audio.get_sample_size(
